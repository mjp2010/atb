...
export function BottomNav() {
 ...
 return (
 <nav className="fixed bottom-0 left-0 w-full flex justify-around items-end px-4 pb-6 pt-2 bg-atb-surface-lowest bg-opacity-90 backdrop-blur-xl rounded-t-[2.5rem] z-50 shadow-lg ">
 {navItems.map((item) => {
