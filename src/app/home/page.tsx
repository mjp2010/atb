      ...
      <main className="max-w-md w-full min-h-screen flex flex-col">
        ...
        <header className="flex items-center justify-between px-6 py-5 sticky top-0 z-50 bg-atb-background bg-opacity-95 backdrop-blur-sm">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-[#fbdac9] flex items-center justify-center overflow-hidden relative shadow-sm border border-atb-outline-variant border-opacity-30">
        ...
        <section className="px-6 mt-1">
          <motion.div
            ...
            className="flex flex-col bg-white rounded-3xl overflow-hidden shadow-sm border border-atb-surface-variant transition-transform hover:shadow-md cursor-pointer"
          >
        ...
        <section className="px-6 mt-14 mb-10">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            whileTap={{ scale: 0.98 }}
            className="bg-[#fcfbf9] p-4 rounded-3xl flex gap-5 border border-atb-outline-variant shadow-sm hover:shadow-md cursor-pointer transition-shadow"
          >
            <div className="w-24 h-24 rounded-2xl bg-white shrink-0 relative shadow-sm flex items-center justify-center p-3 border border-slate-100 overflow-hidden">
              <Image
