...
export default function ShopPage() {
 ...
 <p className="font-body text-atb-on-surface-variant max-w-xs italic pl-4">
 ...
 className="md:col-span-8 bg-atb-surface-low rounded-2xl overflow-hidden flex flex-col md:flex-row group transition-all duration-500 hover:shadow-xl "
 >
 ...
 <div className="flex gap-4 mb-6 py-3 ">
 ...
 <div className="p-3 bg-atb-secondary-container bg-opacity-10 rounded-lg mb-8">
 ...
 {/* Why recommended */}
 <section className="mb-16 bg-atb-surface-high rounded-3xl p-8 md:p-12 ">
