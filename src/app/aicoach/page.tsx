...
export default function AICoachPage() {
 ...
 <header className="bg-atb-surface-lowest px-6 py-4 sticky top-0 z-50 ">
 ...
 className="bg-atb-primary-container bg-opacity-40 p-6 rounded-3xl relative overflow-hidden"
 >
 ...
 whileTap={{ scale: 0.98 }}
 className="flex items-center justify-between p-4 bg-atb-surface-lowest rounded-2xl shadow-sm transition-colors text-left group"
 >
 <div className="flex items-center gap-3">
 ...
 <div className="p-4 bg-atb-surface-lowest rounded-2xl ">
 ...
 className="w-full bg-atb-surface-lowest rounded-full py-4 pl-6 pr-14 font-body text-sm shadow-lg focus:outline-none focus:ring-1 transition-all text-atb-on-surface placeholder:text-atb-outline"
 />
 <motion.button
 whileTap={{ scale: 0.9 }}
