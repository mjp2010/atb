...
export default function TimelinePage() {
 ...
 className="bg-atb-surface-low p-6 rounded-3xl space-y-4 "
 >
 ...
 <button className="text-[10px] font-bold uppercase tracking-widest text-atb-primary px-3 py-1 rounded-full">
 See All
 </button>
 </div>
 ...
 className="flex items-center gap-4 p-4 rounded-2xl bg-atb-surface-lowest shadow-sm"
 >
 <div className={`w-6 h-6 rounded-full flex items-center justify-center ${m.done ? 'bg-atb-primary text-white' : ''}`}>
 ...
 >
 <div className={`flex items-center justify-center w-10 h-10 rounded-full ${item.bg} ${item.color} shadow shrink-0 z-10`}>
 <Icon size={18} fill={i === 1 ? 'currentColor' : 'none'} />
 </div>
 <div className="flex-1 p-6 rounded-2xl bg-atb-surface-lowest shadow-sm ">
 ...
 <p className="font-body text-sm text-atb-on-surface-variant leading-relaxed italic pl-3">{item.body}</p>
 {item.category && (
 <div className="flex gap-2 mt-3">
 <div className="p-2 rounded-lg bg-atb-surface-low flex-1 text-center">
 ...
 <motion.button whileTap={{ scale: 0.96 }} className="flex-1 py-3 bg-atb-surface-lowest rounded-2xl text-xs font-bold flex items-center justify-center gap-2 hover:bg-atb-surface-low transition-colors text-atb-on-surface">
