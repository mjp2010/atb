          ...
          {step === 2 && (
            ...
            >
              ...
              <div className="space-y-6">
                <div className="bg-atb-surface-lowest p-6 rounded-3xl shadow-sm border border-atb-outline-variant focus-within:border-atb-primary focus-within:ring-1 transition-all">
                  <label className="block font-label text-[10px] font-bold uppercase tracking-[0.15em] text-atb-primary mb-2 opacity-70">
                    Baby&apos;s Name
                  </label>
                  <input
                    className="w-full bg-transparent border-none p-0 font-headline text-2xl text-atb-on-surface placeholder:text-atb-outline-variant focus:ring-0 focus:outline-none"
                ...
                <div className="bg-atb-surface-lowest p-6 rounded-3xl shadow-sm border border-atb-outline-variant focus-within:border-atb-primary focus-within:ring-1 transition-all">
                  ...
                  <input
                    className="w-full bg-transparent border-none p-0 font-body text-lg text-atb-on-surface focus:ring-0 focus:outline-none"
                    type="date"
                  />
          ...
          {step === 3 && (
            ...
            >
              <div className="relative mb-10">
                ...
                <div className="absolute -top-1 -right-1 w-10 h-10 rounded-full bg-atb-primary flex items-center justify-center border-4 border-atb-background shadow-md">
