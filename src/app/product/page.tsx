...
export default function ProductPage() {
 ...
 <div className="bg-atb-secondary-container bg-opacity-20 p-4 rounded-2xl flex gap-4">
 ...
 {/* Fixed bottom bar */}
 <div className="fixed bottom-0 left-0 w-full px-6 py-4 bg-atb-surface-lowest z-50">
 <div className="max-w-2xl mx-auto flex gap-4">
 <motion.button
 whileTap={{ scale: 0.92 }}
 className="w-14 h-14 rounded-2xl flex items-center justify-center text-atb-on-surface hover:bg-atb-surface-container transition-colors"
