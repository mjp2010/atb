...
export default function ExpertsPage() {
 ...
 className="bg-atb-surface-lowest rounded-2xl p-6 shadow-lg relative overflow-hidden"
 >
 ...
 className={`flex-1 py-2 rounded-xl text-atb-on-surface transition-colors ${
 slot.disabled
 ? ' bg-atb-surface-container text-atb-on-surface-variant opacity-40 cursor-not-allowed'
 : ' hover:bg-atb-primary-fixed'
 }`}
 >
